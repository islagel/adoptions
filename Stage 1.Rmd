...
intake_date <- c("intake_date", "response", "date", "date animal was placed in shelter", "mm-dd-yyy")
outcome_date <- c("outcome_date", "response", "date", "date animal was removed from shelter", "mm-dd-yyy")
```
