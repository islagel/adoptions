...
Many animals coming into the animal shelter may be in bad shape. Because of this, euthanasia may be the best outcome for the animal. In our data, the `intake_subtype` variable summarises the condition of the animals coming into the shelter. This variable is in the form of a string with 3 descriptors. We are in the midst of using a string analysis to take out relevant infomration. One key word that appeared in many of the obersevations was "REHABILIITATABLE". It is logical that animals which come in in better condition and show promise of getting better are less likely to be euthanized. We may want to adjust for this in our binomial analysis. 
...
From this plot we can see that a higher proportion of dogs (85%) come in with rehabilitable compared to 76% of cats. This infomration could be used in our comparison of cats and dogs. In the coming weeks we plan to dig more into this variable and consult a current vet-med student to learn more about what these key words indicate. 
