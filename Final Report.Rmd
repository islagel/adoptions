...
$$
  ...
  This model was chosen based on information from our exploratory data analysis. . It is important to note that the odds of a pitbull dying in the animal shelter are 3.42 times higher than for non pitbulls accounting for season, chip status, and intake condition, see table 4. As expected, the odds of a contagious dog dying at the animal shelter are 3.96 time higher than a non contagious dog accounting for whether the dog is treatable, the season, chip status and pitbull.
...
stargazer(mod.2.dead,
          apply.coef = exp,
          title="Predicting Dead Outcomes using Multilevel Logistic Regression",
          type='latex',
          align=TRUE,
          header=FALSE,
          intercept.bottom = FALSE,
