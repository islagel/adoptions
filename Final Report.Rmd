...
#### Modeling Time Till Death for Pitbulls
  ...
  We found that in all 4 subsets of the data the coefficient for pitbull is significant. The hazard ratio ranged from 1.69 in the subset where it is not the summer and all the animals have chips to 1.94 in the not summer and all animals do not have a chip dataset. In laymens terms this means that on average at any time during an animals stay at the animal shelter 1.69 to 1.94 times as many pitbulls have died as non pitbulls.
...
stargazer(surv.mod.1.1, surv.mod.1.0, surv.mod.0.1, surv.mod.0.0,
          align=TRUE,
          title = "Results of Stratified Cox Proportional Hazards Survival Analysis",
          header=FALSE,
          table.placement = "H",
          apply.coef = exp,
          ci=TRUE,
          ci.custom = list(ci.func(surv.mod.1.1), ci.func(surv.mod.1.0), ci.func(surv.mod.0.1), ci.func(surv.mod.0.1), ci.func(surv.mod.0.0)),
          dep.var.labels=c("Time Spent in Animal Shelter Prior to Death"),
          model.numbers = FALSE,
