...
### Background
```{r, echo=FALSE, out.height="60%", out.width="60%", fig.align="right"}
include_graphics("pitbull.jpg")
```
...
\begin{multicols}{2}
  ...
  \null \vfill
  \includegraphics[Pitbull, width=.3\textwidth]{pitbull.jpg}
  \vfill \null
...
### EDA 
```{r, echo=FALSE, fig.align="center", out.width="80%", out.height="80%", fig.cap="Outcomes for Pitbulls v.s. Non Pitbulls"}
adoptions %>%
  filter(dog == 1) %>%
